...
1. MUST: All runtime configuration values MUST be sourced from environment variables accessed through process.env or equivalent platform-specific mechanisms

## Policy Block

- MUST All runtime configuration values MUST be sourced from environment variables accessed through process.env or equivalent platform-specific mechanisms
