...
1. MUST: Client runtime request handlers MUST interact with database adapters through event-driven interfaces rather than direct synchronous method calls

## Policy Block

- MUST Client runtime request handlers MUST interact with database adapters through event-driven interfaces rather than direct synchronous method calls
