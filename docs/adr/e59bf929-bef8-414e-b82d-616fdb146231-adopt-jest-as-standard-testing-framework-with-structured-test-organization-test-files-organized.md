...
1. MUST: Test files MUST be organized in dedicated test directories: __tests__/ for unit tests, tests/ for integration/functional/e2e tests

## Policy Block

- MUST Test files MUST be organized in dedicated test directories: __tests__/ for unit tests, tests/ for integration/functional/e2e tests
