...
1. MAY: Service proxies MAY extend the base composite proxy pattern with additional cross-cutting concerns specific to their domain

## Policy Block

- MAY Service proxies MAY extend the base composite proxy pattern with additional cross-cutting concerns specific to their domain
