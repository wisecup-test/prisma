...
1. MUST: Database adapter packages (adapter-pg, adapter-neon, adapter-planetscale) MUST maintain isolated module boundaries with no cross-adapter dependencies

## Policy Block

- MUST Database adapter packages (adapter-pg, adapter-neon, adapter-planetscale) MUST maintain isolated module boundaries with no cross-adapter dependencies
