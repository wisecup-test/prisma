...
1. MUST: Service proxies MUST support transparent error propagation including referential action errors and foreign key constraint violations

## Policy Block

- MUST Service proxies MUST support transparent error propagation including referential action errors and foreign key constraint violations
