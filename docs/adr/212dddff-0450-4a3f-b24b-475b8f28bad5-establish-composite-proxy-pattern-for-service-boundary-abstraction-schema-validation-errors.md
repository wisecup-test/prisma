...
1. MUST: Schema validation errors MUST be detectable and handleable at the service boundary layer

## Policy Block

- MUST Schema validation errors MUST be detectable and handleable at the service boundary layer
