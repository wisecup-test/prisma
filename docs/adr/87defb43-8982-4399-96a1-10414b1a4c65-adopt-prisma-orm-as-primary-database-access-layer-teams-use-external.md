...
1. MAY: Teams MAY use external tables integration when interfacing with legacy database schemas or shared databases

## Policy Block

- MAY Teams MAY use external tables integration when interfacing with legacy database schemas or shared databases
