...
1. MUST_NOT: Raw user input MUST NOT be directly interpolated into queries, commands, or templates without sanitization

## Policy Block

- MUST_NOT Raw user input MUST NOT be directly interpolated into queries, commands, or templates without sanitization
