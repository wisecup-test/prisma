...
1. SHOULD: SQL queries SHOULD include trace context metadata using SQLCommenter format when supported by the database driver

## Policy Block

- SHOULD SQL queries SHOULD include trace context metadata using SQLCommenter format when supported by the database driver
