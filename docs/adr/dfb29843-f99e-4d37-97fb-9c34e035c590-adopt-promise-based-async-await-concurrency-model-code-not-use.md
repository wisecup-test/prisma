...
1. MUST_NOT: Code MUST NOT use callback-based asynchronous patterns for new implementations

## Policy Block

- MUST_NOT Code MUST NOT use callback-based asynchronous patterns for new implementations
