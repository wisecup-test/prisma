...
1. SHOULD: Test suites SHOULD be categorized by type using subdirectories: integration/, functional/, e2e/, unit/ within test directories

## Policy Block

- SHOULD Test suites SHOULD be categorized by type using subdirectories: integration/, functional/, e2e/, unit/ within test directories
