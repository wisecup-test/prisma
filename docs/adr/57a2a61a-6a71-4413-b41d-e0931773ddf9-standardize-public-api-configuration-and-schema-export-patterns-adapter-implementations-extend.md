...
1. MAY: Adapter implementations MAY extend base interfaces with provider-specific functionality, provided core contracts remain satisfied

## Policy Block

- MAY Adapter implementations MAY extend base interfaces with provider-specific functionality, provided core contracts remain satisfied
