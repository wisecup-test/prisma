...
1. SHOULD: Configuration files SHOULD be co-located with their consuming modules in test and integration scenarios to improve discoverability

## Policy Block

- SHOULD Configuration files SHOULD be co-located with their consuming modules in test and integration scenarios to improve discoverability
