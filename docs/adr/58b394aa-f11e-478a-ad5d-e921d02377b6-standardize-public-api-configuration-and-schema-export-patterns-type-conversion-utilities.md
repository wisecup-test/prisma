...
1. MUST: Type conversion utilities in adapters MUST maintain bidirectional transformation guarantees between database-native types and Prisma's type system

## Policy Block

- MUST Type conversion utilities in adapters MUST maintain bidirectional transformation guarantees between database-native types and Prisma's type system
