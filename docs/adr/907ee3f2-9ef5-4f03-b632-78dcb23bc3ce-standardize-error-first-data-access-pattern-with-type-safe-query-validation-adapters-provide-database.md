...
1. MAY: Adapters MAY provide database-specific error extensions for advanced use cases while maintaining the common error interface

## Policy Block

- MAY Adapters MAY provide database-specific error extensions for advanced use cases while maintaining the common error interface
