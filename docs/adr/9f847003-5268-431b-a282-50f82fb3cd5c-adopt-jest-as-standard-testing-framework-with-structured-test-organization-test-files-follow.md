...
1. MUST: Test files MUST follow naming conventions: unit tests use .test.ts suffix, integration/e2e tests use test.ts or tests.ts filenames

## Policy Block

- MUST Test files MUST follow naming conventions: unit tests use .test.ts suffix, integration/e2e tests use test.ts or tests.ts filenames
