...
1. MAY: Adapters MAY emit additional adapter-specific events for monitoring and observability purposes beyond the core integration contract

## Policy Block

- MAY Adapters MAY emit additional adapter-specific events for monitoring and observability purposes beyond the core integration contract
