...
1. MUST: Batch operations and transactions MUST propagate errors with sufficient context to identify which operation in the batch failed

## Policy Block

- MUST Batch operations and transactions MUST propagate errors with sufficient context to identify which operation in the batch failed
