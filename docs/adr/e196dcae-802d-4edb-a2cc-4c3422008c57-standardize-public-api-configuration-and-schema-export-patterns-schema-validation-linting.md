...
1. SHOULD: Schema validation and linting commands SHOULD expose programmatic interfaces alongside CLI interfaces to support tooling integration

## Policy Block

- SHOULD Schema validation and linting commands SHOULD expose programmatic interfaces alongside CLI interfaces to support tooling integration
