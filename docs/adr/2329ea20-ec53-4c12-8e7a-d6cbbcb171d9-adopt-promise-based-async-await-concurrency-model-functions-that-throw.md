...
1. SHOULD: Functions that may throw asynchronously SHOULD document their error conditions in JSDoc comments

## Policy Block

- SHOULD Functions that may throw asynchronously SHOULD document their error conditions in JSDoc comments
