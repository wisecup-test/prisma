...
1. MUST: Database schema definitions MUST be declared in Prisma schema files using the Prisma Schema Language

## Policy Block

- MUST Database schema definitions MUST be declared in Prisma schema files using the Prisma Schema Language
