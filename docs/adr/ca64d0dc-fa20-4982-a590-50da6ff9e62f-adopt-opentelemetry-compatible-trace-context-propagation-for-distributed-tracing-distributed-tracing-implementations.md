...
1. MUST: All distributed tracing implementations MUST use OpenTelemetry-compatible trace context propagation mechanisms to ensure interoperability with standard observability tools

## Policy Block

- MUST All distributed tracing implementations MUST use OpenTelemetry-compatible trace context propagation mechanisms to ensure interoperability with standard observability tools
