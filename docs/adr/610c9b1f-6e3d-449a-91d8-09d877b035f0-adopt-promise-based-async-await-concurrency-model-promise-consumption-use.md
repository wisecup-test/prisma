...
1. MUST: All Promise consumption MUST use await syntax within async contexts rather than .then()/.catch() chains

## Policy Block

- MUST All Promise consumption MUST use await syntax within async contexts rather than .then()/.catch() chains
