...
1. SHOULD: Test files SHOULD use descriptive directory names that indicate the feature or issue being tested (e.g., issues/14373-batch-tx-error/)

## Policy Block

- SHOULD Test files SHOULD use descriptive directory names that indicate the feature or issue being tested (e.g., issues/14373-batch-tx-error/)
