...
1. MUST: All public API modules MUST export configuration through standardized file patterns (prisma.config.ts for runtime configuration, _schema.ts for schema definitions)

## Policy Block

- MUST All public API modules MUST export configuration through standardized file patterns (prisma.config.ts for runtime configuration, _schema.ts for schema definitions)
