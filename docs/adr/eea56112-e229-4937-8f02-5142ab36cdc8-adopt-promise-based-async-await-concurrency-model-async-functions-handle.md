...
1. MUST: All async functions MUST handle errors using try-catch blocks or propagate errors to callers

## Policy Block

- MUST All async functions MUST handle errors using try-catch blocks or propagate errors to callers
