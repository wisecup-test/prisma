...
1. MAY: Applications MAY implement additional context-specific validation beyond the baseline requirements

## Policy Block

- MAY Applications MAY implement additional context-specific validation beyond the baseline requirements
