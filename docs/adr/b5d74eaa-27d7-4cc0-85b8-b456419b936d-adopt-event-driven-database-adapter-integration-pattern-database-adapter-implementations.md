...
1. MUST: All database adapter implementations (Neon, PostgreSQL, etc.) MUST conform to a common event-driven integration contract

## Policy Block

- MUST All database adapter implementations (Neon, PostgreSQL, etc.) MUST conform to a common event-driven integration contract
