...
1. MUST: Test files MUST import from published package entry points (e.g., '@prisma/client') rather than internal implementation paths when testing public APIs

## Policy Block

- MUST Test files MUST import from published package entry points (e.g., '@prisma/client') rather than internal implementation paths when testing public APIs
