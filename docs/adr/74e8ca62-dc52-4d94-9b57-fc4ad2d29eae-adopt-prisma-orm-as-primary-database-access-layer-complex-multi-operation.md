...
1. SHOULD: Complex multi-operation workflows SHOULD use Prisma transactions ($transaction) to ensure atomicity

## Policy Block

- SHOULD Complex multi-operation workflows SHOULD use Prisma transactions ($transaction) to ensure atomicity
