...
1. MUST_NOT: Raw SQL queries MUST NOT bypass Prisma's type system unless absolutely necessary for performance-critical operations

## Policy Block

- MUST_NOT Raw SQL queries MUST NOT bypass Prisma's type system unless absolutely necessary for performance-critical operations
