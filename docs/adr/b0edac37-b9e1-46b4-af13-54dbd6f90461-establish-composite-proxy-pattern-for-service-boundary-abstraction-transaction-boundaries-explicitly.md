...
1. MUST: Transaction boundaries MUST be explicitly defined and testable through the proxy interface

## Policy Block

- MUST Transaction boundaries MUST be explicitly defined and testable through the proxy interface
