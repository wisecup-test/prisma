...
1. MAY: Helper modules for build processes and code generation MAY use relaxed import patterns when operating in development-only contexts

## Policy Block

- MAY Helper modules for build processes and code generation MAY use relaxed import patterns when operating in development-only contexts
