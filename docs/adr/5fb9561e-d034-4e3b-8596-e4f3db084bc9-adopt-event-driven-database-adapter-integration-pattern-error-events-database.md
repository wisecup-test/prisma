...
1. SHOULD: Error events from database adapters SHOULD propagate through the event boundary with sufficient context for client-side error handling and logging

## Policy Block

- SHOULD Error events from database adapters SHOULD propagate through the event boundary with sufficient context for client-side error handling and logging
