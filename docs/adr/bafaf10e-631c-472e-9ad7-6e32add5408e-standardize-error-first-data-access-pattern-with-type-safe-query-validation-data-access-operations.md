...
1. MUST: All data access operations MUST implement error-first handling with explicit error types for constraint violations, foreign key errors, and transaction failures

## Policy Block

- MUST All data access operations MUST implement error-first handling with explicit error types for constraint violations, foreign key errors, and transaction failures
