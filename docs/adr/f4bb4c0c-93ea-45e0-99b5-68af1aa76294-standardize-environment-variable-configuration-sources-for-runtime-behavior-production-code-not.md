...
1. MUST_NOT: Production code MUST NOT contain hardcoded configuration values that should vary by environment (database URLs, API keys, feature flags)

## Policy Block

- MUST_NOT Production code MUST NOT contain hardcoded configuration values that should vary by environment (database URLs, API keys, feature flags)
