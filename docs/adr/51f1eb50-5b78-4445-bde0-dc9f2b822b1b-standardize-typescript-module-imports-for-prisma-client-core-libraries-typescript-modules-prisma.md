...
1. MUST: All TypeScript modules in Prisma packages MUST use explicit import statements with full module paths rather than barrel exports for core runtime components

## Policy Block

- MUST All TypeScript modules in Prisma packages MUST use explicit import statements with full module paths rather than barrel exports for core runtime components
