...
1. MAY: Top-level await MAY be used in module contexts where the runtime supports it (ES modules, Node.js 14.8+)

## Policy Block

- MAY Top-level await MAY be used in module contexts where the runtime supports it (ES modules, Node.js 14.8+)
