...
1. MUST: All database access operations MUST use Prisma Client as the primary ORM interface

## Policy Block

- MUST All database access operations MUST use Prisma Client as the primary ORM interface
