...
1. SHOULD: Input validation SHOULD be performed using Prisma validators before database operations

## Policy Block

- SHOULD Input validation SHOULD be performed using Prisma validators before database operations
