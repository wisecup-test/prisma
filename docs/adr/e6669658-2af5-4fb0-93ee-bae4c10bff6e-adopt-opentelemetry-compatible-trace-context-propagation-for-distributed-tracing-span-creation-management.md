...
1. MUST: Span creation and management MUST follow OpenTelemetry semantic conventions for naming, attributes, and lifecycle management

## Policy Block

- MUST Span creation and management MUST follow OpenTelemetry semantic conventions for naming, attributes, and lifecycle management
