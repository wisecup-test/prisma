...
1. MUST: Referential integrity constraints and foreign key relationships MUST be defined in the Prisma schema with explicit onDelete and onUpdate actions

## Policy Block

- MUST Referential integrity constraints and foreign key relationships MUST be defined in the Prisma schema with explicit onDelete and onUpdate actions
