...
1. SHOULD: Validation rules SHOULD be defined using schema validation libraries or type systems rather than ad-hoc checks

## Policy Block

- SHOULD Validation rules SHOULD be defined using schema validation libraries or type systems rather than ad-hoc checks
