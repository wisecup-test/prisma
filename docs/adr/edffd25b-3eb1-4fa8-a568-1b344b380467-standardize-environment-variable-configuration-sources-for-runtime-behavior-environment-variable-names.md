...
1. SHOULD: Environment variable names SHOULD follow a consistent naming convention with prefixes indicating the component or subsystem (e.g., PRISMA_, DATABASE_, CI_)

## Policy Block

- SHOULD Environment variable names SHOULD follow a consistent naming convention with prefixes indicating the component or subsystem (e.g., PRISMA_, DATABASE_, CI_)
