# Adopt Event-Driven Database Adapter Integration Pattern: Event Boundaries Designed
...
1. SHOULD: Event boundaries SHOULD be designed to support observable testing patterns that allow validation of adapter behavior in isolation

## Policy Block

- SHOULD Event boundaries SHOULD be designed to support observable testing patterns that allow validation of adapter behavior in isolation
