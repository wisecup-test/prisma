...
1. SHOULD: Integration and e2e tests SHOULD be co-located with the features they test using tests/ directories within feature packages

## Policy Block

- SHOULD Integration and e2e tests SHOULD be co-located with the features they test using tests/ directories within feature packages
