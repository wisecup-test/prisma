...
1. MUST: All external input from users, APIs, files, or third-party sources MUST be validated before processing or storage

## Policy Block

- MUST All external input from users, APIs, files, or third-party sources MUST be validated before processing or storage
