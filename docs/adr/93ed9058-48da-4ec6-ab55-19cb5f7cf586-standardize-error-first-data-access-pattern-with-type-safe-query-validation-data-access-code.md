...
1. MUST_NOT: Data access code MUST NOT throw generic Error objects; all errors must use typed error classes with structured metadata

## Policy Block

- MUST_NOT Data access code MUST NOT throw generic Error objects; all errors must use typed error classes with structured metadata
