...
1. MUST: Database adapters MUST normalize database-specific errors into a consistent error hierarchy that abstracts backend differences

## Policy Block

- MUST Database adapters MUST normalize database-specific errors into a consistent error hierarchy that abstracts backend differences
