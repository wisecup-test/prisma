...
1. MUST: Validation logic MUST reject invalid input with clear error messages rather than attempting to correct or coerce malformed data

## Policy Block

- MUST Validation logic MUST reject invalid input with clear error messages rather than attempting to correct or coerce malformed data
