# Adopt Event-Driven Database Adapter Integration Pattern: Adapters Emit Additional
...
- **R-ADAPTER-001** MAY: Adapters MAY emit additional adapter-specific events for monitoring and observability purposes beyond the core integration contract.
...
<enforcement>
Claude Code MUST NOT skip or defer verification. All three verification commands must pass before accepting changes to adapter implementations or client runtime request handling.
</enforcement>