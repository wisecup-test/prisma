# Standardize Error-First Data Access Pattern with Type-Safe Query Validation: Data Access Code
...
- **R-30-001** MUST_NOT: Data access code MUST NOT throw generic Error objects; all errors must use typed error classes with structured metadata.
