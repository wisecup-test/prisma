...
- **R-30-001** SHOULD: Referential action errors (onDelete, onUpdate) SHOULD include the affected entity, constraint name, and suggested resolution.
...
- Referential action errors include affected entity, constraint name, and suggested resolution in error metadata
