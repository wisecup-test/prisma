# Standardize TypeScript Module Imports for Prisma Client Core Libraries: Database Adapter Packages
...
- **R-ADAPTER-001** MUST: Database adapter packages (adapter-pg, adapter-neon, adapter-planetscale) MUST maintain isolated module boundaries with no cross-adapter dependencies.
...
<enforcement>
Claude Code MUST NOT skip or defer verification. All three verification commands must pass before accepting changes to adapter packages, client runtime, or integration test imports.
</enforcement>